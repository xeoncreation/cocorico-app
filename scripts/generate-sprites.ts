 ...
 * Scans `public/sprites/raw` for images, normalizes them to 256x256, builds a horizontal spritesheet.
 * Outputs: `public/sprites/sheet.png` and `public/sprites/sheet.json`.
 */
import fs from 'fs';
...
const SIZE = 256; // target square size
...
async function main() {
  ...
  // Create blank canvas then composite
