      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <Reveal>
          <div className="text-center space-y-6 mb-12">
            ...
            <div>
              <h1 className="heading-display text-cocorico-brown dark:text-amber-100 mb-3">
                Food Scanner
              </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Reveal delay={0.1}>
            ...
            >
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white text-3xl group-hover:scale-110 transition-transform shadow-lg">
                <Scan className="w-8 h-8" />
              </div>
              <h3 className="heading-3 glass-text-strong mb-2">
                Escanear Código
              </h3>
              <p className="body-small glass-text-medium mb-4">
          ...
          <Reveal delay={0.2}>
            ...
            >
              ...
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-white text-3xl group-hover:scale-110 transition-transform shadow-lg">
        ...
        <Reveal delay={0.3}>
          <div className="mt-12 text-center space-y-6">
            <GlassCard className="inline-block p-4 bg-blue-50/50 dark:bg-blue-950/20">
            ...
            <div className="flex justify-center">
              <Button variant="ghost" className="glass-text-medium hover:text-cocorico-brown dark:hover:text-amber-100" asChild>
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          {error && (
            <Reveal delay={0.3}>
              <GlassCard className="p-6 bg-red-50/50 dark:bg-red-950/20 border-red-200 dark:border-red-800">
                <p className="text-red-600 dark:text-red-400 text-center body-regular">
